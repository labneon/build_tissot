...
git clone https://github.com/neonmicky/kernel_xiaomi_tissot -b 12.0-tissot vendor/xiaomi/tissot --depth=1
git clone https://github.com/neonmicky/kernel_xiaomi_tissot -b 12.0-common vendor/xiaomi/msm8953-common --depth=1
